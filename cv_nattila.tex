...
%(Note: (5-month PhD internships at Flatiron Institute).
\\[1.0ex]
\begin{tabular}{L!{\VRule}R}
...
\vspace{-0.3cm}
\noindent
In total, 2 colloquiums, 30 invited talks/seminars, and 31 contributed talks. Most recent ones include:\\[1.0ex]
\begin{tabular}{L!{\VRule}R}
%  2024 & Astro lunch talk, Hebrew University, Israel \\
  2023 & CDY workshop on Black Hole Flares, Flatiron Institute, USA \\
...
%  2022  & $300\,000$ USD, NASA ATP grant, Co-I (PI: A. Beloborodov), Columbia University, USA\\
%        & ``\textit{Magnetic dissipation and radiation from compact objects}''\\
%  2021  & $60\,000$ EUR, Wenner-Gren grant, Co-I (PI: D. Mitra), Nordita, Sweden\\
%          & ``\textit{Reconnection, Radio observations, and switchbacks}''\\
%  2020  & $502\,000$ USD, NASA ATP grant, Co-I (PI: L. Sironi), Columbia University, USA\\
...
and 
V.F~{Suleimanov}.
\newblock {artpol: Analytical ray-tracing method for spectro-polarimetric properties of accretion disks around Kerr black holes}.
\newblock {\em submitted}, 
%503(1):688--693, May 2021,
...
\bibitem{2024ApJS..270...34C}
Q.~{Changeat}, J.~{Skinner}, J.~{Cho}, \textbf{J}.~{\textbf{N\"attil\"a}}, et al. 
\newblock {Is the Atmosphere of the Ultra-hot Jupiter WASP-121 b Variable?}.
\newblock {\em ApJS}, Feb 2024.
...
\newblock {\em Nature Communications}, December 2023.
...
\newblock {\em Phys. Rev. Lett.}, December 2023.
